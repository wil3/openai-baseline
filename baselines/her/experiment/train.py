...
def launch(
    ...
    override_params={}, save_policies=True, flight_log_dir= None
):
...
@click.option('--flight-log-dir', type=str, default=None, help='the path to where logs and policy pickles should go. If not specified, creates a folder in /tmp/')
def main(**kwargs):
    launch(**kwargs)
